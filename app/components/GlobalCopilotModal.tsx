...
export default function GlobalCopilotModal({
  ...
  const [messages, setMessages] = useState<CopilotMessage[]>([
    {
      id: "welcome-copilot",
      sender: "copilot",
      text: "### 🏛️ ¡Bienvenido al Copiloto de Inteligencia Comercial GIAC AIFA!\n\n" +
        "Estoy conectado a la base consolidada de **Locales, Contratos y Finanzas**. " +
        "Puedes hacerme cualquier consulta analítica, pedirme que redacte un oficio oficial o solicitar una recomendación estratégica.",
  ...
  const presets = {
    chat: [
      ...
      "Resumen de marcas en categoría de riesgo C/D",
    ],
    oficio: [
  ...
  return (
    <div className="global-copilot-backdrop" role="dialog" aria-modal="true" aria-label="Copiloto IA Global GIAC AIFA">
      <div className="global-copilot-modal">
        <header className="copilot-header">
          <div className="copilot-brand">
            <span className="copilot-badge">✨ GEMINI 3.6 FLASH</span>
            <h2>Copiloto IA de Inteligencia Comercial</h2>
            <small>GIAC AIFA · Cartera Consolidada ({globalContext.totalLocals} locales, {globalContext.totalContracts} contratos)</small>
          </div>
        ...
        <div className="copilot-messages-container">
              ...
              <div className="copilot-bubble-content">
                {msg.sender === "copilot" && (
                  <span className="copilot-msg-header">
                    ✨ Copiloto GIAC {msg.mode === "gemini-api" ? "· Gemini API" : "· Motor Local"}
                  </span>
                )}
          ...
          {loading && (
            <div className="copilot-bubble copilot loading">
              <div className="copilot-bubble-content">
                <span className="copilot-msg-header">✨ Procesando consulta con Gemini…</span>
                <p>Generando análisis y dictamen institucional...</p>
              </div>
            </div>
          )}
        ...
        >
          <input
            ...
            placeholder={
              activeTab === "oficio"
                ? "Solicita la redacción de un oficio (ej. 'Redactar requerimiento a deudores')..."
                : activeTab === "finance"
                ? "Consulta datos de cobranza o cartera vencida..."
                : "Haz cualquier pregunta estratégica o consulta comercial..."
            }
            disabled={loading}
          />
